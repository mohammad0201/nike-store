            ...
            <header className={
                ...
                <nav className='flex items-center justify-between nike-container'>
                    ...
                    <ul className='flex items-center justify-center gap-2'>
                        ...
                        <li className='grid items-center'>
                            <HeartIcon className={`icon-style ${navState && "text-red-600 transition-all duration-300"}`} />
                        </li>
                        <li className='grid items-center'>
                            <button type='button' onClick={onCartToggle} className='border-none outline-none active:scale-110 transition-all duration-300 relative'>
                                ...
                                <div className={`absolute top-4 right-0 shadow w-4 h-4 text-[0.65rem] leading-tight font-medium rounded-full flex items-center justify-center cursor-pointer hover:scale-110 transition-all duration-300 ${navState ? 'bg-red-600 text-slate-100 bg-slate-100' : 'bg-slate-100 bg-white shadow-slate-100'}`}>{totalQTY}</div>
                            </button>
                        </li>
                    </ul>
                </nav>
