          ...
          {cartItems?.length === 0 ? <CartEmpty onCartToggle={onCartToggle} /> : <div>
            ...
            <div className="fixed bottom-0 bg-white w-full px-5 py-2 grid items-center">
              <div className="flex items-center justify-between">
                ...
                <h1 className="text-base font-semibold uppercase">: حمع کل</h1>
              </div>
              <div className="grid items-center gap-2">
                <p className="text-sm font-medium text-center">مالیات و هزینه حمل و نقل در هنگام تحویل محاسبه می شود</p>
                <button type="button" className="button-theme bg-theme-cart text-white">بررسی شد</button>
              </div>
            </div>
